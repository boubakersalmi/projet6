## ce programme est réalisé sur python 3.7, certains points doivent être adaptés aux versions antérieures de python
######
#####
##### DEBUT DU PROGRAMME
#####
...
chemindetoile = "**************** FIN DE SESSION *******************"
#
############################# Configuration du fond d'écran adaptatif ##############################

#le fichier config_data définit l'emplacement des liens des fonds d'écran. celui-ci peut etre modifié pour pointer sur une autre source
...
fichierutilisateurservices = r'C:\Users\booba\Desktop\filerepo\usersandservices.csv'
...
#definition de la fonction changee_wallpaper
...
typeelementsconfig = r'C:\Users\booba\Desktop\filerepo\type_fichier.json'
